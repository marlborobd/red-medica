...
export const getIstoricPlati = (patientId) => api.get(`/patients/${patientId}/istoric-plati`);
...
export const markToateNotificariCitite = () => api.put('/notificari/citeste-toate');
